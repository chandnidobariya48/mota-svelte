...
<section class="section" id="features">
    <Container>
        <Row class="justify-content-center">
            <div class="col-12">
                <div class="section-title text-center mb-4 pb-2">
                    <h3 class="title mb-3">Our Features</h3>
        ...
        <Row>
            ...
            <Col lg={4} md={6} class="mt-5 pt-4">
                <Card class="features feature-primary feature-shadow-md shadow rounded p-4 pt-5">
                    <div class="icon-style mt-n80 position-relative text-center shadow rounded bg-white mb-4">
                        <i class={"h4 mb-0 uil uil-" + item.icon}></i>
                    </div>
                    <div class="content">
                        <a href="/" class="title text-dark h5">{item.title}</a>
                        <p class="text-muted mt-3">{item.description}</p>
                        <a href="/" class="text-dark title">Read More <i class="uil uil-arrow-right"></i> </a>
                    </div>
                </Card>
            </Col>
            {/each}
        ...
        <Row>
            <Col lg={5}>
                <div class="section-title">
                    <h4 class="section-title mb-3 mb-lg-0">Some of the most importent <br /> things in this tools</h4>
                </div>
            </Col>
    ...
    <Container class="mt-100 mt-60">
        <Row class="align-items-center">
            <Col lg={6} md={6}>
                <img src={Feature1} class="img-fluid shadow-md rounded-md" alt="" />
            </Col>

            <Col lg={6} md={6} class="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div class="section-title ms-lg-5">
                    ...
                    <a href="/" class="mt-3 text-primary">Find Out More <i class="uil uil-angle-right-b"></i></a>
                </div>
            </Col>
        </Row>
    </Container>
    ...
    <Container class="mt-100 mt-60">
        <Row class="align-items-center">
            <Col lg={6} md={6} class="order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
            ...
            <Col lg={6} md={6} class="order-1 order-md-2">
                <img src={Feature2} class="img-fluid shadow-md rounded-md" alt="" />
            </Col>
        </Row>
    </Container>
</section>